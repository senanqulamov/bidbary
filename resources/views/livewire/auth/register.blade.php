...
<div>
    <form wire:submit="register">
        ...
        <div>
            ...
            <x-inputs.text-input wire:model="name" id="name" class="block mt-1 w-full" type="text" name="name" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-inputs.text-input wire:model="email" id="email" class="block mt-1 w-full" type="email" name="email" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-inputs.text-input wire:model="password" id="password" class="block mt-1 w-full"
                            type="password"
                            name="password"
        ...
        <div class="mt-4">
            ...
            <x-inputs.text-input wire:model="password_confirmation" id="password_confirmation" class="block mt-1 w-full"
                            type="password"
